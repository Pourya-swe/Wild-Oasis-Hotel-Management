...
export async function getBookings({ filter, sortBy, page }) {
  // Note: We are selecting not only all the bookings, but also selecting cabin and guest corresponding to those bookings, so we are able to use those data as well.
  let query = supabase
    .from("bookings")
    .select(
